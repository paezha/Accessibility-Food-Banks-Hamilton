...
knitr::opts_chunk$set(
  cache = TRUE, out.width = "90%", fig.width = 6, fig.height = 6
)
```
...
## Data preparation
# Join the food bank data to the travel time tables:
ttm_car <- ttm_car %>%
...
```{r plot-levels-of-service, echo=FALSE, fig.cap="\\label{fig:levels-of-service}Levels of service at each facility pre-COVID-19 (top panel) and during COVID-19 (middle panel). The bottom panel shows the change in level of service."}
## Analysis
...
```{r plot-accessibility, echo=FALSE, fig.align = 'center', out.width = "90%", fig.cap="\\label{fig:accessibility}Accessibility by traffic analysis zone pre-COVID-19 (top panel) and during COVID-19 (middle panel). The bottom panel shows the change in accessibility."}
## Analysis
