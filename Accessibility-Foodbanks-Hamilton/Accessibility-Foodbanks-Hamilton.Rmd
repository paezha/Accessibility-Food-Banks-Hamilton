...
```{r plot-local-i, echo=FALSE, fig.cap="\\label{fig:plot-local-i}Areas with significantly large changes in accessibility from pre-COVID-19 to during COVID-19 according to Local Moran's I." }
ggplot() +
  geom_sf(data = accessibilty_taz_change,
          aes(fill = acc_d,
              color = significance,
  ...
  scale_fill_viridis_c(name = "Change in accessibility",
                       ...
                       labels = c("-0.0008",
                                  ...
                                  "-0.0004",
                                  "-0.0002")) +
  scale_color_manual(values = c("n.s." = NA, 
                                "sig" = "black")) +
