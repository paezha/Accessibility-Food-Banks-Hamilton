...
Data have been prepared for sharing as a data package^[add repository]. This data package consists of the following:
...
foodbank_table %>% kable("latex",
        ...
        col.names = c("Type", 
                      ...
                      "Additional Notes"),
        caption = "\\label{tab:food-bank-info}Food Bank and Food Service Information.",
        escape = FALSE) %>%
...
\noindent where $p^k_i$ is the proportion of trips by mode $k$ in the TAZ of parcel $i$, and $tt^k_{ij}$ is the travel time from parcel $i$ to the food bank. In other words, the expected travel time is the weighted sum of travel times to the foodbank, with the weights given by the expected modal split in the TAZ.
