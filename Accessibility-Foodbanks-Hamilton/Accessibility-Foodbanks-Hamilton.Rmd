...
We use data from the census to model low-income households as a proxy for households that are possibly experiencing food insecurity. However, the degree to which our low-income cut-off of CAD\$40,000 reflects food insecurity in the different zones of the study area is not known.
...
In the absence of information on how food insecure households travel to food banks and related services, we adopted a normative approach that examines accessibility to food banks reachable within 15 minutes based on standards for accessible drinking water... 
